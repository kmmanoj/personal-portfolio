                            ...
                            <div className="mt-5 text-lg leading-loose">
                                <div className="flex flex-col">
                                    <div>
                                        ...
                                        Security Engineer at <a href="https://postman.com">Postman</a>
                                    </div>
                                    <div>
                                        <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 inline-block mr-3" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                                    ...
                                    <div>
                                        ...
                                        <b>Pursuing</b> MS in Computer Science, Georgia Institute of Technology</div>
                                    <div>
                                        ...
                                        <b>Graduated</b> BEngg in Computer Science and Engineering, PES Institute of Technology</div>
                                </div>
                            </div>
                        </div>
                    </Fade>
